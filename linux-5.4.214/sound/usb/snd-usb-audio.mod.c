...
__used __section(__versions) = {
	...
	{ 0x1f59df77, "media_remove_intf_link" },
...
MODULE_ALIAS("usb:v041Ep4095d*dc*dsc*dp*ic*isc*ip*in*");
...
MODULE_INFO(srcversion, "D55C55A51777B38EFDF262B");
